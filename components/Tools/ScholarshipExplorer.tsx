      ...
      <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.08)]">
        {!showResults ? (
          ...
          <>
            ...
            {!isLoading && Array.isArray(results) && Boolean(results.length) && <ForumCTA context="scholarship" />}
          </>
        )}
      </div>
